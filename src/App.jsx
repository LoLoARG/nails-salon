...
const getHorariosPorDia = (fecha) => {
  const horariosDiciembre = {
    ...
    '2025-12-06': ['10:00', '12:00', '14:00', '16:00', '18:00'],
    '2025-12-07': ['09:00', '10:00', '11:00', '12:00', '13:00', '14:00'],
    '2025-12-08': ['07:00', '09:00', '11:00', '13:00'],
    '2025-12-09': ['07:00', '09:00', '10:00', '12:00', '14:00', '16:00', '18:00'],
    ...
    '2025-12-13': ['10:00', '12:00', '14:00', '16:00', '18:00'],
    ...
    '2025-12-20': ['10:00', '12:00', '14:00', '16:00', '18:00'],
  ...
  const handleBooking = () => {
    if (selectedService && selectedDate && selectedTime && customerName && customerPhone) {
      ...
      const turnoData = {
        ...
        clienteEmail: `${customerPhone}@cliente.com` // Email ficticio
      };
      
      setPendingTurnoData(turnoData);
      setShowPayment(true); // Mostrar pantalla de pago
    }
  };
